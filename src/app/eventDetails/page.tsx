  ...
  return (
    <>
      ...
      >
        ...
        {/* Floating icons */}
        <div className="absolute top-20 left-10 animate-float opacity-30 z-10">
          <svg className="w-16 h-16 text-red-500" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          </svg>
        </div>
        <div className="absolute bottom-20 right-10 animate-float-reverse opacity-30 z-10">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <EventCard
              ...
              icon={
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0..." />
              }
            />
          </div>
...
const EventCard = ({
  ...
  <div
    className={`group relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-xl p-6 border border-${color}-500/30 hover:border-${color}-500/60 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-${color}-500/20`}
  >
